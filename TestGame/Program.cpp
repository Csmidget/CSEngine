...
#include "CSEngine/Collision3D.h"
#include "CSEngine/RigidBody3D.h"
#include "CSEngine/Light.h"
#include "CSEngine/MeshRenderer.h"
...
void Program::Init()
{
	...
	auto rb = go->GetComponent<RigidBody3D>().lock()->lockRotation = true;
	auto dc = go->AddComponent<DebugComponent>();
	auto tc = go->AddComponent<TableConstrainer>();
